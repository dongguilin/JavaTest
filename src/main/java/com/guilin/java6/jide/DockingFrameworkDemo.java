...
//    }
//
//    public DockingFrameworkDemo() throws HeadlessException {
//        showDemo(true);
////        JFrame frame = new JFrame();
////        frame.getContentPane().add(_frame);
...
//                showDemo(true);
////                DockingFrameworkDemo demo = new DockingFrameworkDemo();
//
//            }
//        });
//
...
//                        DockingPersistenceUtils.save((DefaultDockingManager) _frame.getDockingManager(), chooser.getSelectedFile().getAbsolutePath());
//                    }
...
//                    if (result == JFileChooser.APPROVE_OPTION) {
//                        _lastDirectory = chooser.getCurrentDirectory().getAbsolutePath();
//                        DockingPersistenceUtils.load((DefaultDockingManager) _frame.getDockingManager(), chooser.getSelectedFile().getAbsolutePath());
//                    }
